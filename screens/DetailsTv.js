...
import {getMovieDetails, getVideos} from '../services/services';
...
const DetailsTV = ({route, navigation}) => {
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.movieDetail}>
          ...
          <Text style={styles.date}>Release Year : {Movie.first_air_date}</Text>
        </View>
        <Recommendations id={id} type="tv" />
      </ScrollView>
      <View style={styles.fixedView}>
        <AddToWatchList id={id} type="tv" />
      </View>
    </View>
  );
};
